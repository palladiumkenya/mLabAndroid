...
//        barChart.animateX(5000, Easing.EasingOption.EaseInBounce);
    ...
    private ArrayList<BarEntry> bgrp4() {
        ...
        bargroup2.add(new BarEntry(getSmsCountEID("02"), 1));
        bargroup2.add(new BarEntry(getSmsCountEID("03"), 2));
        bargroup2.add(new BarEntry(getSmsCountEID("04"), 3));
        bargroup2.add(new BarEntry(getSmsCountEID("05"), 4));
        bargroup2.add(new BarEntry(getSmsCountEID("06"), 5));
        bargroup2.add(new BarEntry(getSmsCountEID("07"), 6));
        bargroup2.add(new BarEntry(getSmsCountEID("08"), 7));
        bargroup2.add(new BarEntry(getSmsCountEID("09"), 8));
        bargroup2.add(new BarEntry(getSmsCountEID("10"), 9));
        bargroup2.add(new BarEntry(getSmsCountEID("11"), 10));
        bargroup2.add(new BarEntry(getSmsCountEID("12"), 11));
        return bargroup2;
    }
